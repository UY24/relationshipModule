# backend/app/services/relationship/url_utils.py
"""URL normalisation, canonicalisation and the disallow-list.

Used to decide whether a URL the model returned is a real, usable official website and
whether it belongs to the company the row is about.
"""
